...
const TeacherBlog = () => {
  ...
  useEffect(() => {
    if (user) {
      console.log('Teacher Blog page: Marking all blogs as read for user:', user.id);
      markAllAsRead();
    }
  }, [user, markAllAsRead]);
            ...
            <div className="flex justify-between items-start mb-4">
             ...
             <div className="mb-6">
               <div className="prose prose-lg max-w-none">
                 <div 
                   className="whitespace-pre-wrap text-gray-800 leading-relaxed text-base sm:text-lg"
                   style={{ 
                     wordWrap: 'break-word',
